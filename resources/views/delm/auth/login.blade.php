<x-guest-layout>
    ...
    <form method="POST" action="{{ route('delm.login.submit') }}">
        @csrf
        ...
        <div class="flex items-center justify-start mt-4 gap-4">
            ...
            <p>
                <a class="underline text-md text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:focus:ring-offset-gray-800" href="{{ route('delm.register') }}">
