        ...
        <form action="{{route('update.vendor-food', $food->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="relative z-0 w-full mb-6 group">
                <select name="category_id" id="category_id" class="block py-2.5 px-4 w-full text-sm text-gray-900 bg-transparent dark:bg-gray-800 border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-200 dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-400 peer">
                    ...
                    <option value="{{$subcategory->id}}" {{$food->category_id === $subcategory->id ? 'selected': ''}}>{{'***** '. $subcategory->name}}</option>
                    @endforeach
                    @endif
                    @endforeach
                </select>
            ...
            <div class="relative z-0 w-full mb-6 group">
                {{-- @php
                dd($food->featured_image)
                @endphp --}}
                <input type="file" name="featured_image" id="featured_image" class="block py-2.5 px-4 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-400 peer"/>
                ...
                <img id="featured_image_preview" class="mt-2 w-60" src="{{$food->featured_image !=null ? asset('storage/'.$food->featured_image): ''}}" alt="Featured Image Preview"  />
              </div>
              <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-6 group">
                  <input type="file" name="first_image" id="first_image" class="block py-2.5 px-4 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-400 peer" />
                  ...
                  <img id="first_image_preview" class="mt-2 w-60" src="{{$food->first_image !=null ? asset('storage/'.$food->first_image): ''}}" alt="First Image Preview" />
                </div>
                <div class="relative z-0 w-full mb-6 group">
                  <input type="file" name="second_image" id="second_image" class="block py-2.5 px-4 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-400 peer"   />
                  <label for="second_image" class="peer-focus:font-medium absolute text-lg text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Add Food Image (optional)</label>
                  <img id="second_image_preview" class="mt-2 w-60" src="{{$food->second_image !=null ? asset('storage/'.$food->second_image): ''}}" alt="Second Image Preview"/>
                </div>
              </div>
              <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-6 group">
                  ...
                  <img id="third_image_preview" class="mt-2 w-60" src="{{$food->third_image !=null ? asset('storage/'.$food->third_image): ''}}" alt="Third Image Preview" />
                </div>
                <div class="relative z-0 w-full mb-6 group">
                  ...
                  <img id="fourth_image_preview" class="mt-2 w-60" src="{{$food->fourth_image !=null ? asset('storage/'.$food->fourth_image): ''}}" alt="Fourth Image Preview" />
                </div>
              </div>

            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" value="{{$food->unit_amount}}" name="unit_amount" id="unit_amount" class="block py-2.5 px-4 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-400 peer" placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-6 group">
                  <select name="unit_name" id="unit_name" class="block py-2.5 px-4 w-full text-sm text-gray-900 bg-transparent dark:bg-gray-800 border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-200 dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-400 peer">
                      ...
                      <option value="{{$unit->unit_name}}" {{$food->unit_name === $unit->unit_name ? 'selected':''}}>* {{$unit->unit_name}}</option>
                      @endforeach
                  </select>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" name="price" value="{{$food->price}}" id="price" class="block py-2.5 px-4 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-400 peer" placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-6 group">
                  <input type="text" name="discount" value="{{$food->discount}}" id="discount" class="block py-2.5 px-4 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-400 peer" placeholder=" " required />
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <div class="relative z-0 w-full mb-6 group">
                  <input type="number" name="available_quantity" value="{{$food->available_quantity}}" id="available_quantity" class="block py-2.5 px-4 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-400 peer" placeholder=" " required />
            ...
            <div class="relative z-0 w-full mb-6 group">
                <textarea name="description" rows="7" id="description" class="block py-2.5 px-4 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-400 peer">{{$food->description}}</textarea>
