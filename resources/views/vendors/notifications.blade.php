    ...
    <div class="pt-4 py-10">
        <div class="relative bg-gray-50 dark:bg-gray-800 pb-10">
            <div class="m-auto px-6 pt-24 md:px-12 lg:pt-[4.8rem] lg:px-7">
                <div class="px-2 md:px-0">
                    <h1 class="text-2xl font-extrabold font-sans text-center mx-auto lg:ml-20 uppercase hover:capitalize text-gray-700 dark:text-gray-200 md:text-4xl lg:w-10/12">Notifications</h1>
                </div>
            </div>
        </div>
        ...
        <div id="alert-additional-content-5" class="p-4 px-8 my-4 mx-auto justify-center border max-w-lg border-gray-300 rounded-lg bg-gray-50 dark:border-gray-600 dark:bg-gray-800" role="alert">
            ...
            <div class="flex gap-2">
                <form action="{{ route('vendor.notifications.markAsRead') }}" method="POST" style="display: inline;">
                    @csrf
                ...
                <form action="{{ route('vendor.notifications.markAsUnread') }}" method="POST" style="display: inline;">
                    @csrf
                    <input type="hidden" name="notification_id" value="{{ $notification->id }}">
        ...
        @empty
        <div class="dark:text-gray-50 text-center">No notifications found.</div>
        @endforelse
        </div>
