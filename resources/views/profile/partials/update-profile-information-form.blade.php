<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        ...
        <div>
            <img id="avatar_preview" src="{{$user->avatar ? asset('storage/'.$user->avatar): asset('images/food-avatar.png')}}" width="200" height="300" alt="Profile Pic">
        ...
        <div>
            <x-input-label for="address" :value="__('Home or Delivery Address')" />
