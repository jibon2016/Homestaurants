<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-start mt-4 gap-4">
            ...
            <p>
                <a class="underline text-md text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:focus:ring-offset-gray-800" href="{{ route('register') }}">
        ...
        <div class="text-center mt-4">
            <p class="text-gray-600 text-md dark:text-gray-400 w-full"><a class="px-2 py-2 bg-blue-400 rounded-md text-white" href="{{route('vendor.register')}}">Join as a Homestaurant's</a></p>
            <p class="text-gray-600 text-md dark:text-gray-400 m-5"><a href="{{route('delm.register')}}" class="px-2 py-2 bg-blue-400 rounded-md text-white">Join as a Rider</a></p>
